...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ theme: ((__VLS_ctx.theme)), }));
    const __VLS_2 = __VLS_1({ theme: ((__VLS_ctx.theme)), }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    var __VLS_6 = {};
    ...
    // @ts-ignore
    const __VLS_20 = __VLS_asFunctionalComponent(__VLS_19, new __VLS_19({ noGutters: (true), }));
    const __VLS_21 = __VLS_20({ noGutters: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_20));
    ...
    // @ts-ignore
    const __VLS_26 = __VLS_asFunctionalComponent(__VLS_25, new __VLS_25({ flat: (true), ...{ class: ("border-b") }, title: ("App Drunagor"), }));
    const __VLS_27 = __VLS_26({ flat: (true), ...{ class: ("border-b") }, title: ("App Drunagor"), }, ...__VLS_functionalComponentArgsRest(__VLS_26));
    ...
    /** @type { [typeof __VLS_components.VBtn, typeof __VLS_components.vBtn, typeof __VLS_components.VBtn, typeof __VLS_components.vBtn, ] } */
    // @ts-ignore
    const __VLS_62 = __VLS_asFunctionalComponent(__VLS_61, new __VLS_61({ ...{ 'onClick': {} }, variant: ("icon"), }));
    const __VLS_63 = __VLS_62({ ...{ 'onClick': {} }, variant: ("icon"), }, ...__VLS_functionalComponentArgsRest(__VLS_62));
    let __VLS_67;
    const __VLS_68 = {
        onClick: (...[$event]) => {
