<template>
  ...
  >
    <v-card>
      <v-card-title class="headline">SAVING YOUR GAME</v-card-title>
      <v-card-text>
        <p>
          You’re done with this game session and it’s time to save your Party’s
          progress. To do so, ensure that no Monsters are alive and that the
          Initiative marker is on the End of the Round Game State Check-Up card,
          at the end of the Initiative Track. If both conditions are met, you
          can save your Party’s progress by first adjusting the board:
        </p>
        <ul>
          <li>
            Remove any Chests and Interaction tokens (if any) left on the board.
        ...
        <ul>
          ...
          <li>
            Record which Rune, Game State Check-Up, and Game Mechanics cards are
        ...
        <p>
          Once all information for all Heroes is filled in, click “Save Changes”
          and you’re done! All the relevant information for your Campaign has
          been recorded. Until next time, dear Adventurer!
        </p>
      </v-card-text>
      <v-card-actions>
        <v-spacer />
