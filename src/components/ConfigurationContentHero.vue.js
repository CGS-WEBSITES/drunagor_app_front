...
function __VLS_template() {
  ...
  const __VLS_1 = __VLS_asFunctionalComponent(
    ...
    new __VLS_0({
      ...{ class: "w-full" },
      dataTestid: "configuration-content-hero",
    }),
  );
  const __VLS_2 = __VLS_1(
    { ...{ class: "w-full" }, dataTestid: "configuration-content-hero" },
  ...
  )({});
  {
    ...
    for (const [content] of __VLS_getVForSourceType(
      __VLS_ctx.contentStore.getAllWithHeroes(),
    )) {
      __VLS_elementAsFunction(
        __VLS_intrinsicElements.div,
        __VLS_intrinsicElements.div,
      )({ key: content.id, ...{ class: "pb-4" } });
      __VLS_elementAsFunction(
      ...
      const __VLS_8 = __VLS_asFunctionalComponent(
        ...
        new __VLS_7({
          variant: "outlined",
          dataTestid: "configuration-content-hero-" + content.id,
          modelValue: __VLS_ctx.heroContentSettings,
          value: content.id,
          ...{ class: "float-right" },
        }),
      );
