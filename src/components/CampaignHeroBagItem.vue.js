...
function __VLS_template() {
    ...
    const __VLS_0 = __VLS_resolvedLocalAndGlobalComponents.ItemCardSelectCategorized;
    /** @type { [typeof __VLS_components.ItemCardSelectCategorized, typeof __VLS_components.ItemCardSelectCategorized, ] } */
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ ...{ 'onClear': {} }, ...{ 'onSelected': {} }, ...{ 'onStash': {} }, categories: ((__VLS_ctx.itemCardCategories)), subTypeList: ((__VLS_ctx.subTypeList)), value: ((__VLS_ctx.itemId)), bagSlot: ((__VLS_ctx.bagSlot)), repository: ((__VLS_ctx.cardsDataRepository)), }));
    const __VLS_2 = __VLS_1({ ...{ 'onClear': {} }, ...{ 'onSelected': {} }, ...{ 'onStash': {} }, categories: ((__VLS_ctx.itemCardCategories)), subTypeList: ((__VLS_ctx.subTypeList)), value: ((__VLS_ctx.itemId)), bagSlot: ((__VLS_ctx.bagSlot)), repository: ((__VLS_ctx.cardsDataRepository)), }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    var __VLS_6 = {};
    let __VLS_7;
    const __VLS_8 = {
