...
function __VLS_template() {
  ...
  __VLS_elementAsFunction(
    ...
    __VLS_intrinsicElements.div,
  )({ id: "campaigns", ...{ class: "grid gap-4 pt-4 place-items-center" } });
  for (const [campaign] of __VLS_getVForSourceType(
    __VLS_ctx.campaignStore.findAll(),
  )) {
    ...
    )({});
    {
      ...
      __VLS_elementAsFunction(
        __VLS_intrinsicElements.div,
        __VLS_intrinsicElements.div,
      )({ ...{ class: "flex flex-wrap justify-center min-h-16" } });
      for (const [hero] of __VLS_getVForSourceType(
        __VLS_ctx.findHeroes(campaign.campaignId),
      )) {
