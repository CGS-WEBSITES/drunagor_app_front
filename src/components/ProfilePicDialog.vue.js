...
const savingPictureHash = ref(null);
const showAlert = ref(false);
const alertIcon = ref("");
const alertText = ref("");
const alertTitle = ref("");
const alertType = ref("info");
const availablePictures = ref([
    { hash: "user.png" },
    { hash: "jaheen.png" },
    { hash: "lich.png" },
    { hash: "lorelai.png" },
...
const selectAndSavePicture = async (pictureHash) => {
    if (isSaving.value)
        return;
    isSaving.value = true;
...
for (const [item, index] of __VLS_getVForSourceType((__VLS_ctx.availablePictures))) {
    const __VLS_36 = {}.VCol;
    ...
    const __VLS_42 = __VLS_41({}, ...__VLS_functionalComponentArgsRest(__VLS_41));
    {
        ...
        const __VLS_45 = __VLS_asFunctionalComponent(__VLS_44, new __VLS_44({
            ...
            ...{ class: ({
                    'active-selection': __VLS_ctx.UserStore.user.picture_hash === item.hash,
                }) },
            rounded: "md",
        }));
        ...
        const __VLS_51 = {
            onClick: (...[$event]) => {
                __VLS_ctx.selectAndSavePicture(item.hash);
            }
        };
        ...
        const __VLS_57 = __VLS_asFunctionalComponent(__VLS_56, new __VLS_56({
            modelValue: (__VLS_ctx.isSaving && __VLS_ctx.savingPictureHash === item.hash),
            contained: true,
...
const __VLS_self = (await import('vue')).defineComponent({
    setup() {
        return {
            ...
            isSaving: isSaving,
            savingPictureHash: savingPictureHash,
            showAlert: showAlert,
            alertIcon: alertIcon,
            alertText: alertText,
            ...
            selectAndSavePicture: selectAndSavePicture,
        };
    },
});
