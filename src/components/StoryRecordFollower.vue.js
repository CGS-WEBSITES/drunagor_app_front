...
function __VLS_template() {
  ...
  const __VLS_1 = __VLS_asFunctionalComponent(
    ...
    new __VLS_0({
      ...
      options: __VLS_ctx.followers,
      maxSelectedLabels: 1,
      filter: true,
      optionLabel: "name",
      optionValue: "id",
      placeholder: __VLS_ctx.$t("text.add-or-remove-follower"),
  ...
  if (__VLS_ctx.followerIds.length > 0) {
    for (const [follower] of __VLS_getVForSourceType(
      __VLS_ctx.findFollowers(__VLS_ctx.followerIds),
    )) {
      __VLS_elementAsFunction(
        __VLS_intrinsicElements.ul,
        __VLS_intrinsicElements.ul,
      )({ ...{ class: "list-disc list-inside pt-2" } });
      __VLS_elementAsFunction(
