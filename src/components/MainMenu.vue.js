...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("card sticky top-0 z-20") }, });
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ density: ("compact"), ...{ class: ("d-flex justify-center") }, }));
    const __VLS_2 = __VLS_1({ density: ("compact"), ...{ class: ("d-flex justify-center") }, }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    for (const [item, i] of __VLS_getVForSourceType((__VLS_ctx.items))) {
        ...
        // @ts-ignore
        const __VLS_7 = __VLS_asFunctionalComponent(__VLS_6, new __VLS_6({ ...{ 'onClick': {} }, color: ("blue"), ...{ class: ("mx-4 elevation-4") }, key: ((i)), prependIcon: ((item.icon)), }));
        const __VLS_8 = __VLS_7({ ...{ 'onClick': {} }, color: ("blue"), ...{ class: ("mx-4 elevation-4") }, key: ((i)), prependIcon: ((item.icon)), }, ...__VLS_functionalComponentArgsRest(__VLS_7));
        let __VLS_12;
        const __VLS_13 = {
            onClick: (...[$event]) => {
                item.command();
