  ...
  <v-card title="Terms & Conditions">
    <v-card-text>
      ...
      <p>
        ...
        App. By using the App, you confirm you meet this requirement.
      </p>
      ...
      <p>
        ...
        <strong>Privacy Policy</strong>, which explains how we collect, use, and
        store your data.
      </p>
      ...
      <p>
        <strong>9. Governing Law</strong> These Terms are governed by the laws
        of Montana.
      </p>
      <p>
