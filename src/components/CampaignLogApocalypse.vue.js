...
function __VLS_template() {
    ...
    [CampaignLogOutcome,];
    // @ts-ignore
    const __VLS_5 = __VLS_asFunctionalComponent(CampaignLogOutcome, new CampaignLogOutcome({ repository: ((__VLS_ctx.outcomeRepository)), campaignId: ((props.campaignId)), heroId: ((props.heroId)), }));
    const __VLS_6 = __VLS_5({ repository: ((__VLS_ctx.outcomeRepository)), campaignId: ((props.campaignId)), heroId: ((props.heroId)), }, ...__VLS_functionalComponentArgsRest(__VLS_5));
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("pt-2 w-full") }, });
    // @ts-ignore
    [CampaignLogAura,];
    // @ts-ignore
    const __VLS_10 = __VLS_asFunctionalComponent(CampaignLogAura, new CampaignLogAura({ repository: ((__VLS_ctx.auraRepository)), campaignId: ((props.campaignId)), heroId: ((props.heroId)), }));
    const __VLS_11 = __VLS_10({ repository: ((__VLS_ctx.auraRepository)), campaignId: ((props.campaignId)), heroId: ((props.heroId)), }, ...__VLS_functionalComponentArgsRest(__VLS_10));
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("pt-4 w-full") }, });
    const __VLS_15 = __VLS_resolvedLocalAndGlobalComponents.RouterLink;
    /** @type { [typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, ] } */
    // @ts-ignore
    const __VLS_16 = __VLS_asFunctionalComponent(__VLS_15, new __VLS_15({ to: (({ name: 'Hero', params: { campaignId: __VLS_ctx.campaignId, heroId: props.heroId } })), ...{ class: ("hero-detail-btn") }, }));
    const __VLS_17 = __VLS_16({ to: (({ name: 'Hero', params: { campaignId: __VLS_ctx.campaignId, heroId: props.heroId } })), ...{ class: ("hero-detail-btn") }, }, ...__VLS_functionalComponentArgsRest(__VLS_16));
    const __VLS_21 = __VLS_resolvedLocalAndGlobalComponents.Button;
    /** @type { [typeof __VLS_components.Button, typeof __VLS_components.Button, ] } */
    // @ts-ignore
    const __VLS_22 = __VLS_asFunctionalComponent(__VLS_21, new __VLS_21({ outlined: (true), label: ((__VLS_ctx.t('label.equipment-skills'))), ...{ class: ("w-full") }, }));
    const __VLS_23 = __VLS_22({ outlined: (true), label: ((__VLS_ctx.t('label.equipment-skills'))), ...{ class: ("w-full") }, }, ...__VLS_functionalComponentArgsRest(__VLS_22));
