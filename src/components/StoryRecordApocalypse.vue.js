...
const followerRepository =
  new StoryRecordFollowerRepository(); /* PartiallyEnd: #3632/scriptSetup.vue */
...
function __VLS_template() {
  ...
  const __VLS_0 = __VLS_asFunctionalComponent(
    StoryRecordFollower,
    new StoryRecordFollower({
      repository: __VLS_ctx.followerRepository,
      campaignId: props.campaignId,
    }),
  );
  const __VLS_1 = __VLS_0(
    { repository: __VLS_ctx.followerRepository, campaignId: props.campaignId },
  ...
  const __VLS_5 = __VLS_asFunctionalComponent(
    StoryRecordOutcome,
    new StoryRecordOutcome({
      repository: __VLS_ctx.outcomeRepository,
      campaignId: props.campaignId,
    }),
  );
  const __VLS_6 = __VLS_5(
    { repository: __VLS_ctx.outcomeRepository, campaignId: props.campaignId },
  ...
  const __VLS_10 = __VLS_asFunctionalComponent(
    StoryRecordStatus,
    new StoryRecordStatus({
      repository: __VLS_ctx.statusRepository,
      campaignId: props.campaignId,
    }),
  );
  const __VLS_11 = __VLS_10(
    { repository: __VLS_ctx.statusRepository, campaignId: props.campaignId },
  ...
  const __VLS_15 = __VLS_asFunctionalComponent(
    StoryRecordUnfolding,
    new StoryRecordUnfolding({ campaignId: props.campaignId }),
  );
