...
// @ts-ignore
const __VLS_19 = __VLS_asFunctionalComponent(StoryRecordOutcome, new StoryRecordOutcome({
...
// @ts-ignore
const __VLS_30 = __VLS_asFunctionalComponent(StoryRecordStatus, new StoryRecordStatus({
...
/** @type {[typeof StoryRecordUnfolding, ]} */ ;
// @ts-ignore
const __VLS_41 = __VLS_asFunctionalComponent(StoryRecordUnfolding, new StoryRecordUnfolding({
    campaignId: (props.campaignId),
}));
