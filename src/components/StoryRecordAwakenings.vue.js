...
function __VLS_template() {
    ...
    [StoryRecordStatus,];
    // @ts-ignore
    const __VLS_5 = __VLS_asFunctionalComponent(StoryRecordStatus, new StoryRecordStatus({ repository: ((__VLS_ctx.statusRepository)), campaignId: ((props.campaignId)), }));
    const __VLS_6 = __VLS_5({ repository: ((__VLS_ctx.statusRepository)), campaignId: ((props.campaignId)), }, ...__VLS_functionalComponentArgsRest(__VLS_5));
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("pt-2 w-full") }, });
    // @ts-ignore
    [StoryRecordOutcome,];
    // @ts-ignore
    const __VLS_10 = __VLS_asFunctionalComponent(StoryRecordOutcome, new StoryRecordOutcome({ repository: ((__VLS_ctx.outcomeRepository)), campaignId: ((props.campaignId)), }));
    const __VLS_11 = __VLS_10({ repository: ((__VLS_ctx.outcomeRepository)), campaignId: ((props.campaignId)), }, ...__VLS_functionalComponentArgsRest(__VLS_10));
