...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_0 = __VLS_asFunctionalComponent(ItemCardSelect, new ItemCardSelect({ ...{ 'onClear': {} }, ...{ 'onSelected': {} }, ...{ 'onStash': {} }, items: ((__VLS_ctx.offHandCards)), itemType: ("Trinket"), subTypeList: ((__VLS_ctx.subTypeList)), value: ((__VLS_ctx.trinketId)), repository: ((__VLS_ctx.cardsDataRepository)), }));
    const __VLS_1 = __VLS_0({ ...{ 'onClear': {} }, ...{ 'onSelected': {} }, ...{ 'onStash': {} }, items: ((__VLS_ctx.offHandCards)), itemType: ("Trinket"), subTypeList: ((__VLS_ctx.subTypeList)), value: ((__VLS_ctx.trinketId)), repository: ((__VLS_ctx.cardsDataRepository)), }, ...__VLS_functionalComponentArgsRest(__VLS_0));
    var __VLS_5 = {};
    let __VLS_6;
    const __VLS_7 = {
