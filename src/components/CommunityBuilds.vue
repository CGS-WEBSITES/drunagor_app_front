<template>
  <div class="page-background d-flex align-center justify-center">
    <v-container class="d-flex justify-center">
      <v-sheet
        ...
        color="secundary"
      >
        <h2 class="font-weight-bold text-h4 text-center mb-4">
          Community Forge <span class="mdi mdi-anvil"></span>
        </h2>
            ...
            <v-list-item-subtitle class="d-md-none mt-2 ml-2">
              <div class="d-flex align-center flex-wrap ga-2">
                ...
                >
                  <template #prepend>
                    <v-avatar class="mr-1" size="16">
                      <v-img
                        src="https://cdn.simpleicons.org/discord/fff"
                      ></v-img>
                    </v-avatar>
                  </template>
                  {{ app.discord }}
                ...
                <v-chip
                  ...
                  size="small"
                  @click.prevent.stop="
                    openLink(`https://github.com/${app.github}`)
                  "
                >
                  {{ app.github }}
                </v-chip>
                <v-chip
                  ...
                  size="small"
                  @click.prevent.stop="
                    openLink(`https://boardgamegeek.com/user/${app.bgg}`)
                  "
                >
                  <template #prepend>
                    <v-avatar class="mr-1" size="16">
...
const applications = ref([
  {
    imageSrc:
      "https://druna-assets.s3.us-east-2.amazonaws.com/community-forge/logo.png",
...
const bggChip = {
  color: "#443f64",
  iconUrl:
    "https://druna-assets.s3.us-east-2.amazonaws.com/community-forge/bgg.png",
};
