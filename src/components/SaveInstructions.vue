    ...
    <v-card-text class="scroll-container">
      ...
      >
        ...
        <template v-slot:item.1>
          <v-card flat>
            <template #title>
              <span class="step-title">1 - Save Conditions</span>
            </template>
        ...
        <template v-slot:item.2>
          <v-card flat>
            <template #title>
              <span class="step-title">2 - Adjusting the Board</span>
            </template>
            <v-list density="compact" class="mb-4 custom-list">
              <v-list-item class="custom-list-item">
                <v-list-item-title class="list-item-text">
        ...
        <template v-slot:item.3>
          <v-card flat>
            <template #title>
              <span class="step-title">3 - Game State Information</span>
            </template>
        ...
        <template v-slot:item.4>
          <v-card flat>
            <template #title>
              <span class="step-title">4 - Hero Information</span>
            </template>
            <p class="step-description mb-2">
        ...
        <template v-slot:item.5>
          <v-card flat>
            <template #title>
              <span class="step-title">5 - Resources & Equipment</span>
            </template>
            <p class="step-description mb-2">
        ...
        <template v-slot:item.6>
          <v-card flat>
            <template #title>
              <span class="step-title">6 - Skills & Abilities</span>
            </template>
            <p class="step-description mb-2">
        ...
        <template v-slot:item.7>
          <v-card flat>
            <template #title>
              <span class="step-title">7 - Save Changes</span>
            </template>
            <p class="step-description mb-4">
