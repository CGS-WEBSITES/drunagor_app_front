...
function __VLS_template() {
    ...
    if (__VLS_ctx.campaign.campaign == 'apocalypse') {
        ...
        // @ts-ignore
        const __VLS_0 = __VLS_asFunctionalComponent(StoryRecordApocalypse, new StoryRecordApocalypse({ campaignId: ((props.campaignId)), }));
        const __VLS_1 = __VLS_0({ campaignId: ((props.campaignId)), }, ...__VLS_functionalComponentArgsRest(__VLS_0));
    }
    if (__VLS_ctx.campaign.campaign == 'awakenings') {
        // @ts-ignore
        [StoryRecordAwakenings,];
        // @ts-ignore
        const __VLS_5 = __VLS_asFunctionalComponent(StoryRecordAwakenings, new StoryRecordAwakenings({ campaignId: ((props.campaignId)), }));
        const __VLS_6 = __VLS_5({ campaignId: ((props.campaignId)), }, ...__VLS_functionalComponentArgsRest(__VLS_5));
    }
