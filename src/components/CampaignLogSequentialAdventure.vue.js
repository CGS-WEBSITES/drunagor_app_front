...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ onClick: (__VLS_ctx.openSequentialStateEditor) }, id: ("seq-adv"), ...{ class: ("pt-2 w-full cursor-pointer") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ id: ("curse-cubes"), ...{ class: ("resource-wrapper text-center flex justify-end") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("w-full") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({ ...{ class: ("block border-b text-lg") }, });
    (__VLS_ctx.sequentialAdventureState.curseCubes);
    __VLS_elementAsFunction(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({ ...{ class: ("whitespace-nowrap") }, });
    (__VLS_ctx.t("text.curse-cubes"));
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ id: ("trauma-cubes"), ...{ class: ("resource-wrapper text-center flex justify-end") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("w-full") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({ ...{ class: ("block border-b text-lg") }, });
    ...
    if (__VLS_ctx.resourceDisplay.length > 0) {
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ id: ("resources"), ...{ class: ("block border-b text-lg") }, });
        for (const [resource] of __VLS_getVForSourceType((__VLS_ctx.resourceDisplay))) {
            __VLS_elementAsFunction(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({ key: ((resource.name)), ...{ class: ("block") }, });
            (resource.count);
            (__VLS_ctx.t(resource.name));
        }
    }
    else {
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("block border-b text-lg") }, });
        __VLS_elementAsFunction(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({ ...{ class: ("italic text-sm text-gray-500") }, });
