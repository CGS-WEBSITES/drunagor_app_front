...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ ...{ 'onClick': {} }, outlined: (true), id: ("campaign-export"), label: ((__VLS_ctx.t('label.back'))), }));
    const __VLS_2 = __VLS_1({ ...{ 'onClick': {} }, outlined: (true), id: ("campaign-export"), label: ((__VLS_ctx.t('label.back'))), }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    let __VLS_6;
    const __VLS_7 = {
        onClick: (...[$event]) => {
    ...
    var __VLS_13;
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("py-2 w-full") }, });
    // @ts-ignore
    [CampaignHeroItems,];
    // @ts-ignore
    const __VLS_14 = __VLS_asFunctionalComponent(CampaignHeroItems, new CampaignHeroItems({ ...{ 'onStash': {} }, campaignId: ((__VLS_ctx.campaignId)), heroId: ((__VLS_ctx.heroId)), repository: ((__VLS_ctx.repository)), hero: ((__VLS_ctx.hero)), }));
    const __VLS_15 = __VLS_14({ ...{ 'onStash': {} }, campaignId: ((__VLS_ctx.campaignId)), heroId: ((__VLS_ctx.heroId)), repository: ((__VLS_ctx.repository)), hero: ((__VLS_ctx.hero)), }, ...__VLS_functionalComponentArgsRest(__VLS_14));
    let __VLS_19;
    const __VLS_20 = {
    ...
    var __VLS_26;
    __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("hero-stash-wrapper py-2 w-full") }, });
    // @ts-ignore
    [CampaignHeroStash,];
    // @ts-ignore
    const __VLS_27 = __VLS_asFunctionalComponent(CampaignHeroStash, new CampaignHeroStash({ campaignId: ((__VLS_ctx.campaignId)), repository: ((__VLS_ctx.repository)), heroId: ((__VLS_ctx.heroId)), key: ((__VLS_ctx.stash)), }));
    const __VLS_28 = __VLS_27({ campaignId: ((__VLS_ctx.campaignId)), repository: ((__VLS_ctx.repository)), heroId: ((__VLS_ctx.heroId)), key: ((__VLS_ctx.stash)), }, ...__VLS_functionalComponentArgsRest(__VLS_27));
    ...
    // @ts-ignore
    const __VLS_38 = __VLS_asFunctionalComponent(CampaignHeroSkills, new CampaignHeroSkills({ campaignId: ((__VLS_ctx.campaignId)), heroId: ((__VLS_ctx.heroId)), }));
    const __VLS_39 = __VLS_38({ campaignId: ((__VLS_ctx.campaignId)), heroId: ((__VLS_ctx.heroId)), }, ...__VLS_functionalComponentArgsRest(__VLS_38));
