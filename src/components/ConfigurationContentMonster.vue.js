...
function __VLS_template() {
  ...
  for (const [content] of __VLS_getVForSourceType(
    __VLS_ctx.contentStore.getAllWithMonsters(),
  )) {
    ...
    const __VLS_20 = __VLS_asFunctionalComponent(
      ...
      new __VLS_19({
        dense: true,
        key: content.id,
        label: __VLS_ctx.$t(content.translation_key),
        modelValue: __VLS_ctx.monsterContentSettings,
        dataTestid: "configuration-content-monster-" + content.id,
        value: content.id,
      }),
    );
