...
function __VLS_template() {
  ...
  const __VLS_1 = __VLS_asFunctionalComponent(
    __VLS_0,
    new __VLS_0({ modelValue: props, timeout: __VLS_ctx.timeout }),
  );
  const __VLS_2 = __VLS_1(
    { modelValue: props, timeout: __VLS_ctx.timeout },
  ...
  )({});
  {
    ...
    const __VLS_8 = __VLS_asFunctionalComponent(
      __VLS_7,
      new __VLS_7({ ...{ onClick: {} }, color: "blue", variant: "text" }),
    );
    const __VLS_9 = __VLS_8(
      { ...{ onClick: {} }, color: "blue", variant: "text" },
