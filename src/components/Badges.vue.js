...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.template, __VLS_intrinsicElements.template)({});
    {
        ...
        (item.description);
        __VLS_elementAsFunction(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({
            ...{ class: ("text-caption grey--text ma-0") },
        });
        (item.date);
    ...
    var __VLS_5;
    ['pa-4', 'pl-1', 'pt-1', 'pr-1', 'pb-0', 'd-flex', 'justify-space-between', 'pb-0', 'text-uppercase', 'font-weight-black', 'text-bold', 'text-h5', 'mb-4', 'pb-0', 'text-uppercase', 'text-bold', 'text-h5', 'mb-4', 'pb-0', 'pt-0', 'py-2', 'px-0', 'mb-1', 'd-flex', 'align-center', 'align-center', 'd-flex', 'align-center', 'justify-center', 'rounded-lg', 'pl-0', 'd-flex', 'flex-column', 'justify-center', 'font-weight-bold', 'white--text', 'ma-0', 'text-body-2', 'grey--text', 'ma-0', 'text-caption', 'grey--text', 'ma-0',];
    var __VLS_slots;
    var $slots;
