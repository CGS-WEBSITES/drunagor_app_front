...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ ...{ 'onClick': {} }, outlined: (true), id: ("campaign-export"), label: ((__VLS_ctx.t('label.export-campaign'))), }));
    const __VLS_2 = __VLS_1({ ...{ 'onClick': {} }, outlined: (true), id: ("campaign-export"), label: ((__VLS_ctx.t('label.export-campaign'))), }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    let __VLS_6;
    const __VLS_7 = {
    ...
    // @ts-ignore
    const __VLS_9 = __VLS_asFunctionalComponent(__VLS_8, new __VLS_8({ visible: ((__VLS_ctx.visible)), modal: (true), header: ((__VLS_ctx.t('label.export-campaign'))), dismissableMask: ((true)), ...{ class: ("w-full md:w-1/3 m-2") }, }));
    const __VLS_10 = __VLS_9({ visible: ((__VLS_ctx.visible)), modal: (true), header: ((__VLS_ctx.t('label.export-campaign'))), dismissableMask: ((true)), ...{ class: ("w-full md:w-1/3 m-2") }, }, ...__VLS_functionalComponentArgsRest(__VLS_9));
    ...
    /** @type { [typeof __VLS_components.Button, typeof __VLS_components.Button, ] } */
    // @ts-ignore
    const __VLS_27 = __VLS_asFunctionalComponent(__VLS_26, new __VLS_26({ ...{ 'onClick': {} }, outlined: (true), label: ((__VLS_ctx.t('label.copy-to-clipboard'))), }));
    const __VLS_28 = __VLS_27({ ...{ 'onClick': {} }, outlined: (true), label: ((__VLS_ctx.t('label.copy-to-clipboard'))), }, ...__VLS_functionalComponentArgsRest(__VLS_27));
    let __VLS_32;
    const __VLS_33 = {
    ...
    /** @type { [typeof __VLS_components.Button, typeof __VLS_components.Button, ] } */
    // @ts-ignore
    const __VLS_35 = __VLS_asFunctionalComponent(__VLS_34, new __VLS_34({ ...{ 'onClick': {} }, outlined: (true), label: ((__VLS_ctx.t('label.cancel'))), }));
    const __VLS_36 = __VLS_35({ ...{ 'onClick': {} }, outlined: (true), label: ((__VLS_ctx.t('label.cancel'))), }, ...__VLS_functionalComponentArgsRest(__VLS_35));
    let __VLS_40;
    const __VLS_41 = {
