...
function __VLS_template() {
  ...
  const __VLS_9 = __VLS_asFunctionalComponent(
    ...
    new __VLS_8({
      ...
      modal: true,
      header: __VLS_ctx.t("text.select-action-cube-color"),
  ...
  for (const [color] of __VLS_getVForSourceType(__VLS_ctx.cubeColors)) {
    ...
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.div,
      __VLS_intrinsicElements.div,
    )({ ...{ class: "flex pt-3 pb-2 pl-3 w-full rounded-lg" } });
    ...
    const __VLS_27 = __VLS_asFunctionalComponent(
      __VLS_26,
      new __VLS_26({ ...{ class: "h-5 w-5 " + color.toLowerCase() } }),
    );
    const __VLS_28 = __VLS_27(
      { ...{ class: "h-5 w-5 " + color.toLowerCase() } },
