...
function __VLS_template() {
  ...
  const __VLS_6 = __VLS_asFunctionalComponent(
    CampaignRemove,
    new CampaignRemove({ campaignId: __VLS_ctx.campaignId }),
  );
  ...
  const __VLS_11 = __VLS_asFunctionalComponent(
    CampaignExport,
    new CampaignExport({ campaignId: __VLS_ctx.campaignId }),
  );
  ...
  const __VLS_16 = __VLS_asFunctionalComponent(
    SequentialAdventureButton,
    new SequentialAdventureButton({
      ...{ onSequentialAdventure: {} },
      campaignId: __VLS_ctx.campaignId,
      disabled: __VLS_ctx.isSequentialAdventure,
    }),
  );
  ...
  const __VLS_23 = __VLS_asFunctionalComponent(
    CampaignCampPhase,
    new CampaignCampPhase({
      ...{ onCampPhase: {} },
      campaignId: __VLS_ctx.campaignId,
    }),
  );
  const __VLS_24 = __VLS_23(
    { ...{ onCampPhase: {} }, campaignId: __VLS_ctx.campaignId },
  ...
  )({});
  {
    ...
    const __VLS_36 = __VLS_asFunctionalComponent(
      CampaignName,
      new CampaignName({ campaignId: __VLS_ctx.campaignId }),
    );
  ...
  if (__VLS_ctx.isSequentialAdventure) {
    ...
    )({});
    {
      ...
      const __VLS_47 = __VLS_asFunctionalComponent(
        CampaignRunes,
        new CampaignRunes({ campaignId: __VLS_ctx.campaignId }),
      );
  ...
  if (
    ...
    const __VLS_52 = __VLS_asFunctionalComponent(
      StoryRecord,
      new StoryRecord({ campaignId: __VLS_ctx.campaignId }),
    );
  ...
  if (__VLS_ctx.campaign.campaign == "apocalypse") {
    ...
    const __VLS_57 =
      __VLS_resolvedLocalAndGlobalComponents.StoryRecordLegacyTrail;
    /** @type { [typeof __VLS_components.StoryRecordLegacyTrail, ] } */
    // @ts-ignore
    const __VLS_58 = __VLS_asFunctionalComponent(
      __VLS_57,
      new __VLS_57({ campaignId: __VLS_ctx.campaignId }),
    );
    ...
    const __VLS_63 =
      __VLS_resolvedLocalAndGlobalComponents.StoryRecordBackgroundAndTrait;
    /** @type { [typeof __VLS_components.StoryRecordBackgroundAndTrait, ] } */
    // @ts-ignore
    const __VLS_64 = __VLS_asFunctionalComponent(
      __VLS_63,
      new __VLS_63({ campaignId: __VLS_ctx.campaignId }),
    );
  ...
  const __VLS_75 = __VLS_asFunctionalComponent(
    CampaignLogAddHero,
    new CampaignLogAddHero({ campaignId: __VLS_ctx.campaignId }),
  );
  ...
  const __VLS_80 = __VLS_asFunctionalComponent(
    CampaignLogRemoveHero,
    new CampaignLogRemoveHero({ campaignId: __VLS_ctx.campaignId }),
  );
  ...
  __VLS_elementAsFunction(
    ...
    id: "heroes",
    ...{ class: "grid pt-2 gap-2 w-full" },
    key: __VLS_ctx.update,
  });
  for (const [hero] of __VLS_getVForSourceType(
    __VLS_ctx.heroStore.findAllInCampaign(__VLS_ctx.campaignId),
  )) {
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.div,
      __VLS_intrinsicElements.div,
    )({ ...{ class: "bg-neutral form-control drop-shadow rounded-lg" } });
    // @ts-ignore
    [CampaignLog];
    // @ts-ignore
