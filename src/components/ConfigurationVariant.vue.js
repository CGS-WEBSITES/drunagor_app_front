...
function __VLS_template() {
    ...
    for (const [variant] of __VLS_getVForSourceType((__VLS_ctx.variantStore.getAll()))) {
        ...
        // @ts-ignore
        const __VLS_20 = __VLS_asFunctionalComponent(__VLS_19, new __VLS_19({ dense: (true), key: ((variant.id)), label: ((__VLS_ctx.$t(variant.translation_key))), modelValue: ((__VLS_ctx.variantSettings)), value: ((variant.id)), }));
        const __VLS_21 = __VLS_20({ dense: (true), key: ((variant.id)), label: ((__VLS_ctx.$t(variant.translation_key))), modelValue: ((__VLS_ctx.variantSettings)), value: ((variant.id)), }, ...__VLS_functionalComponentArgsRest(__VLS_20));
    }
