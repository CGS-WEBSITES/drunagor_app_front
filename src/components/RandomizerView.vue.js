...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ noGutters: (true), ...{ class: ("justify-center") }, }));
    const __VLS_2 = __VLS_1({ noGutters: (true), ...{ class: ("justify-center") }, }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    var __VLS_6 = {};
    const __VLS_7 = __VLS_resolvedLocalAndGlobalComponents.VCol;
    /** @type { [typeof __VLS_components.VCol, typeof __VLS_components.vCol, typeof __VLS_components.VCol, typeof __VLS_components.vCol, ] } */
    // @ts-ignore
    const __VLS_8 = __VLS_asFunctionalComponent(__VLS_7, new __VLS_7({ cols: ("12"), ...{ class: ("pa-4") }, }));
    const __VLS_9 = __VLS_8({ cols: ("12"), ...{ class: ("pa-4") }, }, ...__VLS_functionalComponentArgsRest(__VLS_8));
    // @ts-ignore
    [RandomizerQuickSelect,];
    // @ts-ignore
    const __VLS_13 = __VLS_asFunctionalComponent(RandomizerQuickSelect, new RandomizerQuickSelect({}));
    ...
    /** @type { [typeof __VLS_components.VCol, typeof __VLS_components.vCol, typeof __VLS_components.VCol, typeof __VLS_components.vCol, ] } */
    // @ts-ignore
    const __VLS_19 = __VLS_asFunctionalComponent(__VLS_18, new __VLS_18({ cols: ("12"), ...{ class: ("pa-4") }, }));
    const __VLS_20 = __VLS_19({ cols: ("12"), ...{ class: ("pa-4") }, }, ...__VLS_functionalComponentArgsRest(__VLS_19));
    // @ts-ignore
    [SwappableImage,];
    // @ts-ignore
    const __VLS_24 = __VLS_asFunctionalComponent(SwappableImage, new SwappableImage({ title: ((__VLS_ctx.name)), subTitle: ((__VLS_ctx.variant)), background: ((__VLS_ctx.backgroundImage)), frontImage: ((__VLS_ctx.frontImage)), backImage: ((__VLS_ctx.backImage)), }));
    const __VLS_25 = __VLS_24({ title: ((__VLS_ctx.name)), subTitle: ((__VLS_ctx.variant)), background: ((__VLS_ctx.backgroundImage)), frontImage: ((__VLS_ctx.frontImage)), backImage: ((__VLS_ctx.backImage)), }, ...__VLS_functionalComponentArgsRest(__VLS_24));
    __VLS_nonNullable(__VLS_23.slots).default;
    var __VLS_23;
    const __VLS_29 = __VLS_resolvedLocalAndGlobalComponents.VCol;
    /** @type { [typeof __VLS_components.VCol, typeof __VLS_components.vCol, typeof __VLS_components.VCol, typeof __VLS_components.vCol, ] } */
    // @ts-ignore
    const __VLS_30 = __VLS_asFunctionalComponent(__VLS_29, new __VLS_29({ cols: ("12"), ...{ class: ("d-flex justify-center pa-4") }, }));
    const __VLS_31 = __VLS_30({ cols: ("12"), ...{ class: ("d-flex justify-center pa-4") }, }, ...__VLS_functionalComponentArgsRest(__VLS_30));
    ...
    // @ts-ignore
    const __VLS_36 = __VLS_asFunctionalComponent(__VLS_35, new __VLS_35({ label: ((__VLS_ctx.$t('randomizer.exclude-current-monster'))), modelValue: ((__VLS_ctx.excludeCurrentCharacter)), }));
    const __VLS_37 = __VLS_36({ label: ((__VLS_ctx.$t('randomizer.exclude-current-monster'))), modelValue: ((__VLS_ctx.excludeCurrentCharacter)), }, ...__VLS_functionalComponentArgsRest(__VLS_36));
    __VLS_nonNullable(__VLS_34.slots).default;
    var __VLS_34;
    const __VLS_41 = __VLS_resolvedLocalAndGlobalComponents.VCol;
    /** @type { [typeof __VLS_components.VCol, typeof __VLS_components.vCol, typeof __VLS_components.VCol, typeof __VLS_components.vCol, ] } */
    // @ts-ignore
    const __VLS_42 = __VLS_asFunctionalComponent(__VLS_41, new __VLS_41({ cols: ("12"), ...{ class: ("pa-4") }, }));
    const __VLS_43 = __VLS_42({ cols: ("12"), ...{ class: ("pa-4") }, }, ...__VLS_functionalComponentArgsRest(__VLS_42));
    const __VLS_47 = __VLS_resolvedLocalAndGlobalComponents.VCard;
    /** @type { [typeof __VLS_components.VCard, typeof __VLS_components.vCard, typeof __VLS_components.VCard, typeof __VLS_components.vCard, ] } */
    // @ts-ignore
    const __VLS_48 = __VLS_asFunctionalComponent(__VLS_47, new __VLS_47({ ...{ class: ("d-flex justify-center pa-4") }, }));
    const __VLS_49 = __VLS_48({ ...{ class: ("d-flex justify-center pa-4") }, }, ...__VLS_functionalComponentArgsRest(__VLS_48));
    const __VLS_53 = __VLS_resolvedLocalAndGlobalComponents.VBtn;
    /** @type { [typeof __VLS_components.VBtn, typeof __VLS_components.vBtn, typeof __VLS_components.VBtn, typeof __VLS_components.vBtn, ] } */
    // @ts-ignore
    const __VLS_54 = __VLS_asFunctionalComponent(__VLS_53, new __VLS_53({ ...{ 'onClick': {} }, ...{ class: ("mx-2") }, variant: ("outlined"), }));
    const __VLS_55 = __VLS_54({ ...{ 'onClick': {} }, ...{ class: ("mx-2") }, variant: ("outlined"), }, ...__VLS_functionalComponentArgsRest(__VLS_54));
    let __VLS_59;
    const __VLS_60 = {
        onClick: (...[$event]) => {
    ...
    /** @type { [typeof __VLS_components.VBtn, typeof __VLS_components.vBtn, typeof __VLS_components.VBtn, typeof __VLS_components.vBtn, ] } */
    // @ts-ignore
    const __VLS_62 = __VLS_asFunctionalComponent(__VLS_61, new __VLS_61({ ...{ 'onClick': {} }, ...{ class: ("mx-2") }, variant: ("outlined"), }));
    const __VLS_63 = __VLS_62({ ...{ 'onClick': {} }, ...{ class: ("mx-2") }, variant: ("outlined"), }, ...__VLS_functionalComponentArgsRest(__VLS_62));
    let __VLS_67;
    const __VLS_68 = {
        onClick: (...[$event]) => {
    ...
    /** @type { [typeof __VLS_components.VBtn, typeof __VLS_components.vBtn, typeof __VLS_components.VBtn, typeof __VLS_components.vBtn, ] } */
    // @ts-ignore
    const __VLS_70 = __VLS_asFunctionalComponent(__VLS_69, new __VLS_69({ ...{ 'onClick': {} }, ...{ class: ("mx-2") }, variant: ("outlined"), }));
    const __VLS_71 = __VLS_70({ ...{ 'onClick': {} }, ...{ class: ("mx-2") }, variant: ("outlined"), }, ...__VLS_functionalComponentArgsRest(__VLS_70));
    let __VLS_75;
    const __VLS_76 = {
        onClick: (...[$event]) => {
    ...
    /** @type { [typeof __VLS_components.VBtn, typeof __VLS_components.vBtn, typeof __VLS_components.VBtn, typeof __VLS_components.vBtn, ] } */
    // @ts-ignore
    const __VLS_78 = __VLS_asFunctionalComponent(__VLS_77, new __VLS_77({ ...{ 'onClick': {} }, ...{ class: ("mx-2") }, variant: ("outlined"), }));
    const __VLS_79 = __VLS_78({ ...{ 'onClick': {} }, ...{ class: ("mx-2") }, variant: ("outlined"), }, ...__VLS_functionalComponentArgsRest(__VLS_78));
    let __VLS_83;
    const __VLS_84 = {
        onClick: (...[$event]) => {
