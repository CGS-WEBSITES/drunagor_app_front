...
function __VLS_template() {
  ...
  if (__VLS_ctx.unfoldingIds.length > 0) {
    for (const [unfolding] of __VLS_getVForSourceType(
      __VLS_ctx.findUnfoldings(__VLS_ctx.unfoldingIds),
    )) {
      __VLS_elementAsFunction(
        __VLS_intrinsicElements.ul,
        __VLS_intrinsicElements.ul,
      )({ ...{ class: "list-disc list-inside py-2" } });
      __VLS_elementAsFunction(
