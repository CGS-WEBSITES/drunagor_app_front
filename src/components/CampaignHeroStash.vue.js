...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({ "data-testid": ("item-stash"), });
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ modelValue: ((__VLS_ctx.stashedItemIds)), options: ((__VLS_ctx.items)), maxSelectedLabels: ((1)), filter: (true), optionLabel: ("name"), optionValue: ("id"), placeholder: ((__VLS_ctx.$t('text.add-or-remove-stashed-items'))), ...{ class: ("w-full md:w-14rem") }, }));
    const __VLS_2 = __VLS_1({ modelValue: ((__VLS_ctx.stashedItemIds)), options: ((__VLS_ctx.items)), maxSelectedLabels: ((1)), filter: (true), optionLabel: ("name"), optionValue: ("id"), placeholder: ((__VLS_ctx.$t('text.add-or-remove-stashed-items'))), ...{ class: ("w-full md:w-14rem") }, }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    if (__VLS_ctx.stashedItemIds.length > 0) {
        ...
        for (const [itemCard] of __VLS_getVForSourceType((__VLS_ctx.findItemCards(__VLS_ctx.stashedItemIds)))) {
            __VLS_elementAsFunction(__VLS_intrinsicElements.ul, __VLS_intrinsicElements.ul)({ id: ("hero-stash-display"), ...{ class: ("list-disc list-inside") }, });
