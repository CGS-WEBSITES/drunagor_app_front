  ...
  <v-card title="Privacy Policy">
    <v-card-text>
      ...
      <p>
        ...
        This Privacy Policy explains how [Creative Games Studio LLC collects,
        uses, and protects your personal data in compliance with GDPR and CCPA.
      </p>
      ...
      <ul class="ml-8">
        ...
        <li>Fulfillment of a contract (e.g., providing App functionality).</li>
      ...
      <p>
        ...
        We retain your data for as long as necessary to provide the App services
      ...
      <p>
        ...
        purposes of App functionality. These parties are contractually obligated
      ...
      <p>
        ...
        Data may be transferred to servers located outside of your country. We
        comply with GDPR and CCPA requirements for such transfers.
      </p>

      <p>
        <strong>11. Children's Privacy</strong>

        We do not knowingly collect data from children under 16 without parental
        consent.
      </p>
      ...
      <p>
        ...
        We may update this Privacy Policy. Changes will be communicated via the
        App or email.
      </p>
