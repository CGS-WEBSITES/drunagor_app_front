...
let query = ref("");
query.value = preselectedKeyword; /* PartiallyEnd: #3632/scriptSetup.vue */
...
function __VLS_template() {
  ...
  const __VLS_1 = __VLS_asFunctionalComponent(
    __VLS_0,
    new __VLS_0({ ...{ class: "w-full sticky top-16 z-10 mb-3" } }),
  );
  const __VLS_2 = __VLS_1(
    { ...{ class: "w-full sticky top-16 z-10 mb-3" } },
  ...
  )({});
  {
    ...
    const __VLS_7 = __VLS_6(
      { ...{ onSearch: {} }, id: "keyword-search", value: __VLS_ctx.query },
  ...
  const __VLS_14 = __VLS_asFunctionalComponent(
    __VLS_13,
    new __VLS_13({ id: "keyword-list", ...{ class: "w-full" } }),
  );
  const __VLS_15 = __VLS_14(
    { id: "keyword-list", ...{ class: "w-full" } },
  ...
  for (const [keyword] of __VLS_getVForSourceType(__VLS_ctx.filteredKeyword)) {
    ...
    const __VLS_20 = __VLS_asFunctionalComponent(
      __VLS_19,
      new __VLS_19({ header: keyword.keyword }),
    );
    ...
    __VLS_asFunctionalDirective(__VLS_directives.vHtml)(
      null,
      {
        ...
        modifiers: {},
        value: __VLS_ctx.marked.parse(keyword.description),
      },
      null,
      null,
    );
