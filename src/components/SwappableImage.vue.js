...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ ...{ class: ("d-flex flex-column justify-center align-center") }, }));
    const __VLS_2 = __VLS_1({ ...{ class: ("d-flex flex-column justify-center align-center") }, }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    var __VLS_6 = {};
    ...
    // @ts-ignore
    const __VLS_32 = __VLS_asFunctionalComponent(__VLS_31, new __VLS_31({ rounded: (true), src: ((__VLS_ctx.currentImage)), ...{ class: ("bg-black") }, width: ("378"), }));
    const __VLS_33 = __VLS_32({ rounded: (true), src: ((__VLS_ctx.currentImage)), ...{ class: ("bg-black") }, width: ("378"), }, ...__VLS_functionalComponentArgsRest(__VLS_32));
    ...
    if (__VLS_ctx.backImage) {
        ...
        // @ts-ignore
        const __VLS_44 = __VLS_asFunctionalComponent(__VLS_43, new __VLS_43({ ...{ 'onClick': {} }, icon: (true), }));
        const __VLS_45 = __VLS_44({ ...{ 'onClick': {} }, icon: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_44));
        let __VLS_49;
        const __VLS_50 = {
            onClick: (...[$event]) => {
                if (!((__VLS_ctx.backImage)))
