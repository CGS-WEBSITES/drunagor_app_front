...
function __VLS_template() {
  ...
  var __VLS_6 = {};
  const __VLS_7 = __VLS_resolvedLocalAndGlobalComponents.VMain;
  ...
  var __VLS_12;
  const __VLS_19 = __VLS_resolvedLocalAndGlobalComponents.AppFooter;
  /** @type { [typeof __VLS_components.AppFooter, ] } */
  // @ts-ignore
