...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/AssemblyTutorial': RouteRecordInfo<'/AssemblyTutorial', '/AssemblyTutorial', Record<never, never>, Record<never, never>>,
    '/BoxAssemblyGuide': RouteRecordInfo<'/BoxAssemblyGuide', '/BoxAssemblyGuide', Record<never, never>, Record<never, never>>,
    ...
    '/PlaytestAgenda': RouteRecordInfo<'/PlaytestAgenda', '/PlaytestAgenda', Record<never, never>, Record<never, never>>,
